...
![](assets/image-20240724215927034.png)


>线程控制块由结构体 struct rt_thread 定义并形成线程内核对象，再链接到内核对象容器中进行管理。

![](assets/image-20240724145353277.png)
线程继承自rt_object
...
- 
 ![](assets/image-20240724160148000.png)
...
![](assets/image-20240724220543587.png)
...
![](assets/image-20240724175427749.png)

这时在进入这个函数的定义就可以发现上图所有的函数都在里面了

![](assets/image-20240724180334608.png)
...
![](assets/image-20240724215346880.png)

init初始化创建了一个线程，然后startup启动了这个线程，看下这个创建线程的定义

![](assets/image-20240724215807652.png)
...
![](assets/image-20240724220051028.png)
...
![](assets/image-20240724222207275.png)
...
![](assets/image-20240724222740916.png)
...
编译运行看下效果
![](assets/image-20240725004539783.png)
